...
echo <<< EOD
	<article>
		<p><span class="italic-center">RESUME OF AMY YUEN YING CHAN</span>
		<p><span class="italic">Note that my LinkedIn profile is typically more up-to-date. Please feel free to <a href="https://www.linkedin.com/in/amyyychan">make a connection!</a></span>
		<p><span class="underlined-category">EDUCATION & PROFESSIONAL DEVELOPMENT</span>
		<ul class="indent">
			...
			<li><span class="italic">Relevant Coursework:</span> Python Programming, MySQL Databases, Advanced PHP Programming, Programming Fundamentals: C++, Network Security, Linux Administration Projects.<li>
		...
		<p><span class="underlined-category">EXPERIENCES</span>
			...
			<ul class="textul">
				...
				<li>Communication: Worked with the director on site organization and idea brainstorming.</li>
			</ul>
